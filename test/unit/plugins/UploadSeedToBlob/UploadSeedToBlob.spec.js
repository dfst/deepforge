...
/**
 * Generated by PluginGenerator 2.16.0 from webgme on Fri Dec 08 2017 17:36:14 GMT-0600 (CST).
 */

describe('UploadSeedToBlob', function () {
    const testFixture = require('../../../globals');
    const gmeConfig = testFixture.getGmeConfig();
    const expect = testFixture.expect;
    const logger = testFixture.logger.fork('UploadSeedToBlob');
    const PluginCliManager = testFixture.WebGME.PluginCliManager;
    const projectName = 'testProject';
    const pluginName = 'UploadSeedToBlob';
    let project,
        gmeAuth,
        storage,
        commitHash;
